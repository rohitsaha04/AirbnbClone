...
function scrolll() {
    var right = document.querySelector(".scroll-images-trip");
    right.scrollBy(-650, 0)
  }
  function scrollr() {
    var left = document.querySelector(".scroll-images-trip");
    left.scrollBy(650, 0)
  }
...
function Plan() {
  return (
    <div className='main-plan'>
        <h1 className='head-plan'>Plan a trip with help from local Hosts around the world</h1>
